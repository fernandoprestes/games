...
function start() {
  ...
  $('#inicio').hide()
  $('#fundoGame').append("<div id='jogador' class='animaHeliceAmiga'></div>")
  $('#fundoGame').append("<div id='inimigo1' class='animaHeliceInimiga'></div>")
  ...
  var velocidade = 5
  // Respawn no eixo vertical
  var posicaoY = parseInt(Math.random() * 334)

  function moveinimigo1() {
    //movimentar no eixo horizontal
  ...
  // Movimento do fundo e o jogador
  function loop() {
    musica.play()
    movefundo()
    movejogador()
